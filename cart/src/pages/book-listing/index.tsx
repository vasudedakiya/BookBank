...
const BookList: React.FC = () => {
	...
	const addToCart = (book: BookModel): void => {
		if (!authContext.user.id) {
			...
			Shared.addToCart(book, authContext.user.id).then(
				...
				<Grid container className="title-wrapper">
					...
					<FormControl className="dropdown-wrapper" variant="outlined">
						...
						>
							...
							{/* <MenuItem value="lower">lower to upper prize</MenuItem>
							<MenuItem value="upper">upper to lower prize</MenuItem> */}
							...
							<div className="product-list">
								<div className="product-list-inner">
									...
									<div className="content-wrapper">
										...
										<button onClick={() => addToCart(book)} className="MuiButtonBase-root MuiButton-root MuiButton-contained btn pink-btn MuiButton-containedPrimary MuiButton-disableElevation">
